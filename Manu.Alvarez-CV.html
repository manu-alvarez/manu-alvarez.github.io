    ...
    <div class="container">
        <header>
            ...
            <div class="contact-info">
				...
				<span>🔗 <a href="https://github.com/manu-alvarez/" target="_blank">GitHub</a></span>
            </div>
        </header>
        ...
        <div class="section">
            ...
            <div class="skills-grid">
                ...
                <div class="skill-item">
                    ...
                    Docker, Git/GitHub, Nginx, Coolify, n8n, Flowise, OpenWebUI, Excalidraw
                </div>
                <div class="skill-item">
                ...
                <div class="skill-item">
                    <strong>Virtualización</strong>
                    VMware, VirtualBox, Parallels Desktop, KVM
                </div>
                <div class="skill-item">
                    <strong>Gestión remota</strong>
                    RDP, SSH, SFTP, VNC, TeamViewer, AnyDesk
                </div>
                <div class="skill-item">
                    <strong>Inteligencia Artificial</strong>
                    Self-hosting con Ollama, prompting con modelos OpenAI, ChatGPT, Claude, Gemini, Qwen
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="project-card">
                ...
                <div style="margin-top: 15px;">
                    <a href="https://github.com/manu-alvarez/CalendarioMaya-ManoElectricaAzul" target="_blank" class="project-link">
                        <span>📂</span> Ver código en GitHub
                    </a>
                    <a href="https://play.google.com/store/apps/details?id=com.manoelectricaazul.app" target="_blank" class="project-link">
